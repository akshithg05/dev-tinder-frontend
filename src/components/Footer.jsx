...
export default function Footer() {
  return (
    <footer className="bg-base-300 shadow-sm text-neutral-content p-6">
      <div className="flex flex-col sm:flex-row w-full items-start sm:items-center justify-between gap-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-6 text-sm">
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
            ...
            <Link to="/shipping" className="hover:underline hover:text-primary">
              Shipping
            </Link>
            <Link to="/terms" className="hover:underline hover:text-primary">
              Terms &amp; Conditions
            </Link>
            <Link to="/refunds" className="hover:underline hover:text-primary">
        ...
        <div className="flex items-center gap-4 ml-auto">
          ...
          <a
            className="cursor-pointer hover:scale-110 transition-transform duration-200"
            href="https://www.instagram.com/qr/"
